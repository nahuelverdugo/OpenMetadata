...
class Workflow:
    ...
    def __init__(self, config: OpenMetadataWorkflowConfig):
        ...
        self._retrieve_source_config_if_needed(metadata_config, service_type)
    ...
    def _retrieve_source_config_if_needed(
        self, metadata_config: OpenMetadataConnection, service_type: ServiceType
    ) -> None:
        """
        ...
        if service_type is ServiceType.Database and self.is_metadata_source_type(
            ...
            metadata = OpenMetadata(config=metadata_config)
            dbt_config_source: object = metadata.secrets_manager_client.retrieve_database_service_metadata_config(
